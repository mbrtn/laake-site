    ...
    <>
      ...
      <div className={css.page}>
        <div className={css.test}>
          <h1>Fyramedia Terms of Service</h1>
          <h2>21. Terms</h2>
          <p>
            ...
            prohibited from using or accessing Läke. The materials contained in
            Läke are protected by applicable copyright and trademark law.
          </p>
          <h2>2. Use License</h2>
          <ul>
            <li>
          ...
          <h2>4. Limitations</h2>
          <p>
            In no event shall Fyramedia or its suppliers be liable for any
            damages (including, without limitation, damages for loss of data or
            profit, or due to business interruption) arising out of the use or
            inability to use Läke, even if Fyramedia or a Fyramedia authorised
          ...
          <p>
            ...
            typographical, or photographic errors. Fyramedia does not warrant
            that any of the materials on Läke are accurate, complete or current.
            Fyramedia may make changes to the materials contained in Läke at any
            time without notice. However Fyramedia does not make any commitment
          ...
          <p>
            ...
            without notice. By using Läke you are agreeing to be bound by the
            then current version of these terms of service.
          </p>
          <h2>8. Governing Law</h2>
          <p>
            These terms and conditions are governed by and construed in
            accordance with the laws of Cyprus and you irrevocably submit to the
